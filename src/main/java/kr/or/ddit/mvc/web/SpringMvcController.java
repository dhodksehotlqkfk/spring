...
//		session.setAttribute("userId", userId);
		...
		// forward : "forward:url주소";		<- 이렇게 할때는 다른 컨트롤러로 forward하고 싶을 때(
																						//http method에 대해 고려해야함
																						//원본요청이 get이면 forward 메소드도 get)
	}
	...
	public String responseStatus() throws NoFileException {
		...
		//NoFileException에 설정한 @ResponseStatus에 의해 500상태코드가 아닌 404 상태코드로 응답 생성
